...
sap.ui.define([
...
], function (jQuery, ToggleButton, InvisibleText, Toolbar, ToolbarSpacer, OverflowToolbarLayoutData, Utils, OverviewToolbarAssociativePopover, OverviewToolbarAssociativePopoverControls) {
    "use strict";
     ...
     * @alias ps.app.ui.lib.OverviewToolbar
     */
    var OverviewToolbar = Toolbar.extend("ps.app.ui.lib.OverviewToolbar", {
        metadata: {
            aggregations: {
                _overflowButton: {
